...
;(function($){
  $.fn.msAccordion = function(options) {
    ...
    allDivs.each(function(current) {
                 ...
                 var titleDiv = $(currentDiv).find("div.newsTitle");
                 titleDiv.attr("id", sTitleID);
                 var contentDiv = $(currentDiv).find("div.newsContent");
    ...
    function makeVertical() {
      ...
      $("#"+elementid +" > div > div.newsTitle").css({display:"block", float:"none", clear:"both"});
      $("#"+elementid +" > div > div.newsContent").css({clear:"both"});
    };
    function startPlay() {
