...
<script id="previewTmpl" type="text/x-jquery-tmpl">
      <div id="ib-img-preview" class="ib-preview" style = "z-index:100000">
                ...
                <div class="ib-main">
                    ...
                    { 
                        ...
                        { 
                            ...
                            $tobeecho = $image=get_the_post_thumbnail( $post->ID, array(450,450), array('class'=>'slide','data-largesrc'=>$image));
                            if(1)
                            {?>
                            <a href="#"><? echo $tobeecho ?><span><? echo $post->post_title ?></span></a> 
                            <?
                            $c++;
                            }
                            }
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/gallery/js/jquery.tmpl.min.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/gallery/js/jquery.kinetic.js"></script>
                    ...
                    Template    = (function() {
                        ...
                        var kinetic_moving              = false,
                            ...
                            loadImgPreview              = function( $item, callback ) {
                                ...
                                var largeSrc        = $item.children('img').attr('data-largesrc'),
                                    description     = $item.children('span').text(),
                                    largeImageData  = {
                                        src         : largeSrc,
                                        description : description
                                    };
                                // document.title = largeSrc;
                                // preload large image
